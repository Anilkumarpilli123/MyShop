...
export const productData = {
  fashion: [
  { id: 1, name: "Nike Air Zoom", price: "$25", image: shoes1, category: "shoes", description: "Lightweight and breathable running shoes for everyday use.", features: ["Air Zoom technology", "Mesh upper", "Rubber outsole"], useCase: "Best for road running and gym workouts." },
  { id: 2, name: "Adidas Runner", price: "$40", image: shoes2, category: "shoes", description: "Comfortable runners with great arch support.", features: ["Cloudfoam midsole", "Flexible knit upper", "Durable tread"], useCase: "Ideal for joggers and walkers." },
  { id: 3, name: "Classic Sneakers", price: "$35", image: shoes, category: "shoes", description: "Trendy sneakers for casual outings.", features: ["Stylish design", "Lace-up closure", "All-day comfort"], useCase: "Perfect for daily wear and street fashion." },
  { id: 4, name: "Puma Speed", price: "$30", image: shoes3, category: "shoes", description: "Speed-enhancing shoes with great grip.", features: ["Speed traction sole", "Synthetic upper", "Comfort padding"], useCase: "Great for sports and gym training." },
  { id: 5, name: "Reebok Flex", price: "$28", image: shoes4, category: "shoes", description: "Flexible sole that moves with your foot.", features: ["Flex grooves", "Mesh fabric", "Padded collar"], useCase: "Ideal for cardio and HIIT workouts." },
  { id: 6, name: "New Balance 574", price: "$45", image: shoes5, category: "shoes", description: "Retro-style with modern comfort.", features: ["Cushioned midsole", "Classic suede design", "Supportive heel"], useCase: "Great for casual wear and long walks." },
  { id: 7, name: "Asics Gel-Kayano", price: "$50", image: shoes6, category: "shoes", description: "Stability running shoe with gel support.", features: ["Gel cushioning", "Stabilizing heel clutch", "Breathable mesh"], useCase: "Perfect for overpronators and marathon training." },
  { id: 8, name: "Under Armour HOVR", price: "$55", image: shoes7, category: "shoes", description: "Responsive and stylish training shoes.", features: ["HOVR cushioning", "Energy return", "Lightweight upper"], useCase: "Best for cross-training and casual wear." },
  { id: 9, name: "Casual Cotton Tee", price: "$18", image: shirts1, category: "shirts", description: "A soft and breathable cotton T-shirt for everyday comfort.", features: ["100% cotton", "Regular fit", "Machine washable"], useCase: "Ideal for daily wear and casual outings." },
  { id: 10, name: "Slim Fit Polo", price: "$25", image: shirts2, category: "shirts", description: "Smart and stylish polo shirt for a semi-formal look.", features: ["Pique fabric", "Collared neck", "Short sleeves"], useCase: "Great for casual Fridays or lunch dates." },
  { id: 11, name: "Classic White Shirt", price: "$30", image: shirts3, category: "shirts", description: "Timeless white shirt with a crisp finish.", features: ["Cotton blend", "Button-down collar", "Long sleeves"], useCase: "Perfect for office wear or formal events." },
  { id: 12, name: "Graphic Printed Tee", price: "$20", image: shirts4, category: "shirts", description: "Trendy T-shirt with bold, expressive prints.", features: ["Vibrant graphic", "Soft touch", "Relaxed fit"], useCase: "Best for weekend hangouts and casual wear." },
  { id: 13, name: "Stylish Hoodie", price: "$35", image: shirts5, category: "shirts", description: "Rugged denim shirt for a cool, laid-back style.", features: ["Heavy denim fabric", "Chest pockets", "Snap buttons"], useCase: "Great for layering or wearing solo." },
  { id: 14, name: "Denim Jacket", price: "$50", image: shirts6, category: "shirts", description: "Lightweight shirt made from breathable linen blend.", features: ["Linen-cotton mix", "Roll-up sleeves", "Relaxed fit"], useCase: "Perfect for summer days and vacations." },
  { id: 15, name: "Casual Chinos", price: "$40", image: shirts7, category: "shirts", description: "Cozy flannel shirt with a classic checkered pattern.", features: ["Brushed flannel", "Warm and soft", "Button cuffs"], useCase: "Ideal for cool weather and layering." },
  { id: 16, name: "Formal Trousers", price: "$45", image: shirts8, category: "shirts", description: "Comfortable henley with a touch of stretch.", features: ["3-button placket", "Slim fit", "Stretch fabric"], useCase: "Great for casual wear or under jackets." },
  { id: 17, name: "Classic Denim Jacket", price: "$45", image: jacket1, category: "jacket", description: "Timeless denim jacket that suits any casual outfit.", features: ["Button-up front", "Chest pockets", "Durable denim fabric"], useCase: "Perfect for layering over T-shirts and hoodies." },
    { id: 18, name: "Leather Biker Jacket", price: "$75", image: jacket2, category: "jacket", description: "Edgy and stylish leather jacket with a classic biker look.", features: ["Zippered pockets", "Asymmetrical front zip", "Faux leather material"], useCase: "Ideal for nights out and street fashion." },
    { id: 19, name: "Bomber Jacket", price: "$60", image: jacket3, category: "jacket", description: "Lightweight and comfortable bomber jacket for cooler days.", features: ["Ribbed cuffs and hem", "Zipper closure", "Soft lining"], useCase: "Great for casual wear and fall evenings." },
    { id: 20, name: "Puffer Jacket", price: "$65", image: jacket4, category: "jacket", description: "Warm and cozy puffer jacket designed to keep out the cold.", features: ["Down insulation", "Water-resistant", "Zip-up front"], useCase: "Best for winter wear and snowy conditions." },
    { id: 21, name: "Hooded Parka", price: "$70", image: jacket5, category: "jacket", description: "Heavy-duty parka with a fur-lined hood for extra warmth.", features: ["Windproof shell", "Adjustable waist", "Fleece lining"], useCase: "Perfect for harsh weather and outdoor activities." },
    { id: 22, name: "Trench Coat", price: "$80", image: jacket6, category: "jacket", description: "Elegant trench coat that adds sophistication to any look.", features: ["Double-breasted", "Waist belt", "Water-repellent fabric"], useCase: "Great for rainy days and formal outerwear." },
    { id: 23, name: "Windbreaker Jacket", price: "$50", image: jacket7, category: "jacket", description: "Ultra-light windbreaker for active and windy days.", features: ["Packable design", "Elastic cuffs", "Ventilated back"], useCase: "Ideal for running, hiking, and travel." },
    { id: 24, name: "Varsity Jacket", price: "$55", image: jacket8, category: "jacket", description: "Sporty varsity jacket with a college vibe.", features: ["Contrasting sleeves", "Snap buttons", "Soft lining"], useCase: "Perfect for casual hangouts and layering." },
    { id: 25, name: "Faux Fur Jacket", price: "$68", image: jacket9, category: "jacket", description: "Luxurious faux fur jacket that feels ultra-soft.", features: ["Plush texture", "Hook closure", "Warm insulation"], useCase: "Best for evening outings and cold weather chic." },
    { id: 26, name: "Urban Street Hoodie", price: "$35", image: hoodies1, category: "hoodies", description: "Casual and cozy pullover hoodie made from soft fleece.", features: ["Kangaroo pocket", "Adjustable drawstring hood", "Ribbed cuffs and hem"], useCase: "Perfect for daily wear, lounging, or layering in cooler weather." },
    { id: 27, name: "Classic Pullover Hoodie", price: "$30", image: hoodies2, category: "hoodies", description: "Versatile zip-up hoodie that’s easy to wear and style.", features: ["Full zipper", "Split kangaroo pockets", "Fleece lining"], useCase: "Ideal for casual outings, workouts, and quick layering." },
    { id: 28, name: "Zippered Sports Hoodie", price: "$40", image: hoodies3, category: "hoodies", description: "Trendy hoodie with bold graphic print and streetwear vibe.", features: ["Printed design", "Drawstring hood", "Soft inner lining"], useCase: "Great for making a statement on casual days or at events." },
    { id: 29, name: "Fleece Lined Hoodie", price: "$45", image: hoodies4, category: "hoodies", description: "Relaxed-fit oversized hoodie for comfort and style.", features: ["Loose fit", "Dropped shoulders", "Brushed fleece fabric"], useCase: "Perfect for lounging, traveling, and cozy weekends." },
    { id: 30, name: "Oversized Graphic Hoodie", price: "$38", image: hoodies5, category: "hoodies", description: "Stylish cropped hoodie with a sporty silhouette.", features: ["Shorter length", "Elastic waistband", "Soft cotton blend"], useCase: "Ideal for gym, casual wear, and pairing with high-waisted pants." },
    { id: 31, name: "Lightweight Summer Hoodie", price: "$28", image: hoodies6, category: "hoodies", description: "Thick fleece hoodie to keep you warm in cold weather.", features: ["Thermal fleece lining", "Ribbed hems", "Heavyweight fabric"], useCase: "Great for winter, layering, and outdoor comfort." },
    { id: 32, name: "Tie-Dye Hoodie", price: "$33", image: hoodies7, category: "hoodies", description: "Colorful tie-dye hoodie for a retro, fun look.", features: ["Unique dye pattern", "Drawstring hood", "Soft cotton material"], useCase: "Perfect for festivals, casual hangouts, and relaxed vibes." },
    { id: 33, name: "Minimalist Plain Hoodie", price: "$32", image: hoodies8, category: "hoodies",  description: "Tailored hoodie with a slim fit for a clean look.", features: ["Tapered design", "Side pockets", "Stretch cotton fabric"], useCase: "Great for layering under jackets or wearing to casual meetups." },
    { id: 34, name: "Vintage Washed Hoodie", price: "$37", image: hoodies9, category: "hoodies", description: "Ultra-warm hoodie lined with plush sherpa fleece.", features: ["Sherpa interior", "Zippered front", "Thick exterior material"], useCase: "Ideal for chilly mornings, outdoor walks, and winter wear." },
    { id: 35, name: "Classic Leather Tote", price: "$85", image: handbag1, category: "handbag", description: "Elegant leather tote with ample space and timeless design.", features: ["Genuine leather", "Inner compartments", "Top handles"], useCase: "Perfect for work, meetings, and daily use." },
    { id: 36, name: "Quilted Chain Bag", price: "$120", image: handbag2, category: "handbag", description: "Chic quilted handbag with metallic chain strap.", features: ["Quilted pattern", "Magnetic snap", "Gold-tone chain"], useCase: "Ideal for evening events and special occasions." },
    { id: 37, name: "Crossbody Mini Bag", price: "$60", image: handbag3, category: "handbag", description: "Compact and lightweight crossbody bag for essentials.", features: ["Adjustable strap", "Zipper closure", "Minimalist design"], useCase: "Best for errands, walks, and festivals." },
    { id: 38, name: "Boho Fringe Handbag", price: "$70", image: handbag4, category: "handbag", description: "Trendy handbag with fringe detailing and boho flair.", features: ["Suede-like material", "Tassel fringe", "Shoulder strap"], useCase: "Perfect for casual outfits and concerts." },
    { id: 39, name: "Structured Satchel", price: "$95", image: handbag5, category: "handbag", description: "Polished satchel with structure and functionality.", features: ["Firm shape", "Double handles", "Interior zip pockets"], useCase: "Ideal for office, meetings, and formal wear." },
    { id: 40, name: "Bucket Shoulder Bag", price: "$80", image: handbag6, category: "handbag", description: "Trendy bucket bag with drawstring and bucket silhouette.", features: ["Adjustable strap", "Drawstring closure", "Soft leather look"], useCase: "Great for weekend outings and casual wear." },
    { id: 41, name: "Elegant Clutch Purse", price: "$50", image: handbag7, category: "handbag", description: "Slim and stylish clutch perfect for evening glamour.", features: ["Snap closure", "Slim profile", "Glossy finish"], useCase: "Ideal for parties, weddings, and formal dinners." },
    { id: 42, name: "Canvas Shopper Tote", price: "$40", image: handbag8, category: "handbag", description: "Spacious tote made from sturdy canvas material.", features: ["Eco-friendly fabric", "Large capacity", "Open top"], useCase: "Best for shopping, groceries, and day trips." },
    { id: 43, name: "Metallic Evening Bag", price: "$110", image: handbag9, category: "handbag", description: "Shiny evening bag with elegant metallic finish.", features: ["Hard shell", "Clasp closure", "Detachable chain strap"], useCase: "Perfect for galas, formal events, and date nights." },
    { id: 44, name: "Designer Logo Handbag", price: "$150", image: handbag10, category: "handbag", description: "Luxury handbag featuring signature logo and premium quality.", features: ["Branded hardware", "Leather trim", "Interior organizer"], useCase: "Ideal for fashion-forward professionals and brand lovers." },
    { id: 45, name: "Casual Drawstring Bag", price: "$65", image: handbag11, category: "handbag", description: "Relaxed bag with drawstring closure for a sporty look.", features: ["Durable nylon", "Front pocket", "Adjustable straps"], useCase: "Great for gym, travel, and everyday errands." },
],
 electronics:[
  {
  id: 46,
...
},
{
  ...
  price: "$24",
  image: personaldevelopmentbooks1,
...
},
{
  ...
  price: "$22",
  image: personaldevelopmentbooks2,
  category: "personaldevelopmentbooks",
...
},
{
  ...
  price: "$20",
  image: personaldevelopmentbooks3,
  category: "personaldevelopmentbooks",
...
},
{
  ...
  price: "$21",
  image: personaldevelopmentbooks4,
  category: "personaldevelopmentbooks",
...
},
{
  ...
  price: "$23",
  image: personaldevelopmentbooks5,
  category: "personaldevelopmentbooks",
...
},
{
  ...
  price: "$19",
  image: personaldevelopmentbooks6,
  category: "personaldevelopmentbooks",
...
},
{
  ...
  price: "$28",
  image: personaldevelopmentbooks7,
  category: "personaldevelopmentbooks",
...
},
{
  ...
  price: "$21",
  image: personaldevelopmentbooks8,
  category: "personaldevelopmentbooks",
